...
import TermsConditionscss from "./Terms&Conditions.module.css";
const TermsConditions = () => {
  const [showTerms, isshowTermsCond] = useState(false);

  return (
    <React.Fragment>
      <main className={TermsConditionscss.wrap}>
        <section className={TermsConditionscss.container}>
          <div className={TermsConditionscss.containerheading}>
            <h2 className={TermsConditionscss.h2}>Payments & Refunds Policy</h2>
          </div>
          <div className={TermsConditionscss.containercontent}>
            <h2 className={TermsConditionscss.smallheaders}>Payment Policy </h2>
            <div>
              <p className={TermsConditionscss.smallp}>
            ...
            <h2 className={TermsConditionscss.smallheaders}>Refund Policy </h2>
            <p className={TermsConditionscss.smallp}>
          ...
          <div className={TermsConditionscss.containernav}>
            <small className={TermsConditionscss.small}>
              By clicking 'Accept' you are agreeing to our payments and refunds
              policy.
            </small>
            <a
              className={TermsConditionscss.button}
              href="/Trainee"
            >
              Accept
            </a>
